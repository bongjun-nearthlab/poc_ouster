...
namespace Spinnaker
{
    ...
    {
        /** Default method. (Deprecated, please select one of the color processing method below) */
        DEFAULT,
        /** No color processing. */
        NO_COLOR_PROCESSING,
        /**
    ...
    enum ImageStatus
    {
        ...
        IMAGE_NO_ERROR = 0,         /**< Image is returned from GetNextImage() or Convert() calls without any errors. */
        ...
        IMAGE_DATA_INCOMPLETE =
            9, /**< Image data is incomplete. Could be caused by missing packet(s) or decompression error. See link above.*/
    ...
    enum SpinnakerLogLevel
    {
        ...
        LOG_LEVEL_ERROR = 300,  // Failures that may or may not be recoverable without user
    ...
    enum PayloadTypeInfoIDs
    {
        ...
        PAYLOAD_TYPE_EXTENDED_CHUNK = PAYLOAD_TYPE_CUSTOM_ID + 1,
        PAYLOAD_TYPE_LOSSLESS_COMPRESSED = PAYLOAD_TYPE_CUSTOM_ID + 2,
        PAYLOAD_TYPE_LOSSY_COMPRESSED = PAYLOAD_TYPE_CUSTOM_ID + 3,
        PAYLOAD_TYPE_JPEG_LOSSLESS_COMPRESSED = PAYLOAD_TYPE_CUSTOM_ID + 4,
        PAYLOAD_TYPE_CHUNK_DATA_LOSSLESS_COMPRESSED = PAYLOAD_TYPE_CUSTOM_ID + 5,
        PAYLOAD_TYPE_CHUNK_DATA_LOSSY_COMPRESSED = PAYLOAD_TYPE_CUSTOM_ID + 6,
        PAYLOAD_TYPE_JPEG_EXTENDED_CHUNK = PAYLOAD_TYPE_CUSTOM_ID + 7
