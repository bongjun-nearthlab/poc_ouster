...
extern "C"
{
    ...
    */
     ...
     * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no error
     */
    SPINNAKERC_API_DEPRECATED("spinImage post processing methods are replaced by the spinImageProcessor methods",
     ...
     */
    SPINNAKERC_API_DEPRECATED("spinImage post processing methods are replaced by the spinImageProcessor methods",
                              spinImageSetNumDecompressionThreads(unsigned int numThreads);)
     ...
     */
    SPINNAKERC_API_DEPRECATED("spinImage post processing methods are replaced by the spinImageProcessor methods",
                              spinImageGetNumDecompressionThreads(unsigned int* pNumThreads);)
    ...
    SPINNAKERC_API_DEPRECATED(
        "spinImage post processing methods are replaced by the spinImageProcessor methods",
        spinImageConvert(spinImage hSrcImage, spinPixelFormatEnums pixelFormat, spinImage hDestImage);)
