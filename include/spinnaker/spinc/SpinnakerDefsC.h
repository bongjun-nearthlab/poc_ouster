...
typedef enum _spinLogLevel
{
    ...
    LOG_LEVEL_NOTICE = 500, // Events such as camera arrival and removal, initialization
                            // and deinitialization, starting and stopping image acquisition,
                            // and feature modification.
    LOG_LEVEL_INFO = 600,   // Information about recurring events that are generated regularly
